...
This is only a short list of the many open-source license that can be used. More in-depth Information on both licenses covered and not covered here can be found at <https://opensource.org/licenses>.  
...
**A**: Follow [these](https://help.github.com/articles/adding-a-license-to-a-repository/) steps.