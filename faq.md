...
**A**: Typically, no. The VT GitHub Organization is meant for public repositories. While still under construction, private repositories should be stored at [code.vt.edu](https://code.vt.edu). However, there may be some expections to this rule.
